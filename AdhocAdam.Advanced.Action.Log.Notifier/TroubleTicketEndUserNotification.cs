...
namespace Advanced.Action.Log.Notifier
{
    ...
    //this is triggered when an Analyst leaves a Public comment to notify the Affected User
    public partial class TroubleTicketEndUserNotification : SendNotificationsActivity
    {
        //define the Workflow Parameters coming in from the Management Pack
        public static DependencyProperty SubscriptionIdProperty = DependencyProperty.Register("SubscriptionId", typeof(Guid), typeof(TroubleTicketEndUserNotification));
        public static DependencyProperty DataItemsProperty = DependencyProperty.Register("DataItems", typeof(string[]), typeof(TroubleTicketEndUserNotification));
        public static DependencyProperty InstanceIdsProperty = DependencyProperty.Register("InstanceIds", typeof(string[]), typeof(TroubleTicketEndUserNotification));
        ...
        public Guid SubscriptionId
        {
            get
            {
                return ((Guid)(base.GetValue(TroubleTicketEndUserNotification.SubscriptionIdProperty)));
            }
            set
            {
                base.SetValue(TroubleTicketEndUserNotification.SubscriptionIdProperty, value);
            }
        }
        ...
        public string[] DataItems
        {
            get
            {
                return ((string[])(base.GetValue(TroubleTicketEndUserNotification.DataItemsProperty)));
            }
            set
            {
                base.SetValue(TroubleTicketEndUserNotification.DataItemsProperty, value);
            }
        }
        ...
        public string[] InstanceIds
        {
            get
            {
                return ((string[])(base.GetValue(TroubleTicketEndUserNotification.InstanceIdsProperty)));
            }
            set
            {
                base.SetValue(TroubleTicketEndUserNotification.InstanceIdsProperty, value);
            }
        }
